      ...
      <section className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {GALLERY_ITEMS.map((item) => (
            ...
            >
              <div className="aspect-square bg-gradient-to-br from-blue-950 to-slate-900 relative overflow-hidden">
                {item.image ? (
                  <img
                    src={item.image}
                    alt={item.title}
          ...
          {selectedItem && (
            <>
              <DialogHeader>
                ...
                {selectedItem.badge && (
                  <Badge className="w-fit bg-blue-600 hover:bg-blue-700 mt-2">
                    {selectedItem.badge}
                  </Badge>
                )}
              </DialogHeader>
              <div className="space-y-4">
                <div className="aspect-video bg-gradient-to-br from-blue-950 to-slate-900 rounded-lg overflow-hidden">
                  {selectedItem.image ? (
                    <img
                  ...
                  <div className="space-y-2">
                    ...
                    <ul className="space-y-2">
                      {selectedItem.details.map((detail, index) => (
                        // biome-ignore lint/suspicious/noArrayIndexKey: static gallery details
