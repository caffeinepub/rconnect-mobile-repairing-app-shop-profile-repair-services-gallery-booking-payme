...
import { useCustomerBookings, useTrackBooking } from "@/hooks/useBookings";
import {
  AlertCircle,
  Calendar,
  FileText,
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Enter your booking ID and phone number to view your repair service
            status
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto mb-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Enter your booking reference number and the phone number you
                used when booking
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSearch} className="space-y-4">
                ...
                <div className="flex gap-3">
                  <Button
                    type="submit"
                    className="flex-1"
                    disabled={trackBooking.isPending}
                  >
        ...
        {trackBooking.isError && (
          <div className="max-w-2xl mx-auto">
            <Alert variant="destructive">
              ...
              <AlertDescription>
                Booking not found or phone number doesn't match. Please check
          ...
          <div className="max-w-4xl mx-auto space-y-8">
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      <CardTitle className="text-xl">
                        Booking #{foundBooking.id.toString()}
                      </CardTitle>
                ...
                <CardContent className="space-y-3">
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="font-medium">
                      {foundBooking.deviceModel}
                    </span>
                  </div>
                  <div className="flex items-start gap-2 text-sm">
                    <FileText className="w-4 h-4 text-muted-foreground mt-0.5" />
                    <span className="text-muted-foreground line-clamp-2">
                      {foundBooking.issueDescription}
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <Calendar className="w-4 h-4 text-muted-foreground" />
                    <span className="text-muted-foreground">
                      Booked on {formatDate(foundBooking.timestamp)}
                    </span>
                  </div>
                </CardContent>
              </Card>
            ...
            {customerBookings.isError && (
              <Alert>
                <AlertCircle className="h-4 w-4" />
                <AlertDescription>
                  Unable to load booking history. This feature requires admin
                  access.
                </AlertDescription>
              </Alert>
            )}
