...
export const GALLERY_ITEMS: GalleryItem[] = [
  {
    ...
    fullDescription:
      "Professional iPhone screen replacement service using high-quality OLED display. The repair includes complete testing of touch sensitivity, display colors, and brightness levels to ensure perfect functionality.",
  ...
  },
  {
    ...
    fullDescription:
      "Replace your old battery with a genuine high-capacity battery. Our service includes battery health diagnostics, proper installation, and calibration for optimal performance.",
  ...
  },
  {
    ...
    fullDescription:
      "Comprehensive water damage repair service including complete disassembly, professional cleaning of all components, corrosion treatment, and thorough testing before reassembly.",
  ...
  },
  {
    ...
    fullDescription:
      "Professional charging port repair or replacement service. We fix loose connections, damaged pins, and ensure proper charging functionality with thorough testing.",
  ...
  },
  {
    ...
    fullDescription:
      "Comprehensive repair services for all Android devices including screen replacement, battery service, and component repairs with quality parts and expert technicians.",
  ...
  },
  {
    ...
    fullDescription:
      "We handle all types of mobile repairs including camera issues, speaker problems, button repairs, and more. Our expert technicians diagnose and fix any problem efficiently.",
  ...
  },
  {
    ...
    fullDescription:
      "Premium AMOLED display replacement for Samsung devices with original quality parts and professional installation.",
  ...
  },
  {
    ...
    fullDescription:
      "Complete software services including OS updates, virus and malware removal, data recovery, and device optimization for better performance.",
